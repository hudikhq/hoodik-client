...
void main() {
  ...
  patrolTest('a folder is findable by name right after it is created', ($) async {
    unawaited(app.main());
    await $.pumpAndSettle();
  ...
  patrolTest('the sweep rebuilds an index the migration cleared', ($) async {
    unawaited(app.main());
    await $.pumpAndSettle();
  ...
  patrolTest('a file is findable by its content digest', ($) async {
    unawaited(app.main());
    await $.pumpAndSettle();
